...
You cannot set this to true while a L<header_handler> value is set.
...
processes that are spawned (in the case of L<processes> being greater than
one).

You cannot set this to true while a L<header_skip> value is set.
...
This performs the L<dolines> functionality, calling the code provided.  If
the filename is not provided, the L<file> attribute is used for this.  See the
L<dolines> and L<parallel_dolines> functions for more information on how this
functions.
...
This performs the L<greplines> functionality, calling the code provided.  If
the filename is not provided, the L<file> attribute is used for this.  See the
L<greplines> and L<parallel_greplines> functions for more information on how
this functions.
...
This performs the L<maplines> functionality, calling the code provided.  If
the filename is not provided, the L<file> attribute is used for this.  See the
L<maplines> and L<parallel_maplines> functions for more information on how
this functions.
...
This performs the L<readlines> functionality.  If the filename is not provided,
the L<file> attribute is used for this.  See the L<readlines> function for more
information on how this functions.

The output is a list of all input lines.

Note that this function is unaffected by the value of the L<processes>
